...
A package that uses [tensorflow](https://www.tensorflow.org/) and the [U-Net](https://paperswithcode.com/paper/u-net-convolutional-networks-for-biomedical) neural network architecture to segment 3D grayscale images of concrete samples.
